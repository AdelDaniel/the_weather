...
class GeolocatorTestScreen extends StatefulWidget {
  static const String id = "GeolocatorTestScreen";

  /// Utility method to create a page with the Baseflow templating.

  @override
  _GeolocatorTestScreenState createState() => _GeolocatorTestScreenState();
}

class _GeolocatorTestScreenState extends State<GeolocatorTestScreen> {
